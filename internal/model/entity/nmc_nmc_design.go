...
// NmcNmcDesign is the golang structure for table nmc_nmc_design.
type NmcNmcDesign struct {
	Did           int64       `json:"did"           description:"设计稿自增id"`           // 设计稿自增id
	...
	IsVip         bool        `json:"isVip"         description:"是否收费,1收费，0不收费，默认1"` // 是否收费,1收费，0不收费，默认1
}
